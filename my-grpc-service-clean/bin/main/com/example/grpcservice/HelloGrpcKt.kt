...
import com.example.grpcservice.HelloServiceGrpc.getServiceDescriptor
 ...
 * com.example.grpcservice.HelloService.
 */
public object HelloServiceGrpcKt {
  ...
  /**
   * A stub for issuing RPCs to a(n) com.example.grpcservice.HelloService service as suspending
   * coroutines.
   */
  ...
  /**
   * Skeletal implementation of the com.example.grpcservice.HelloService service based on Kotlin
   * coroutines.
   */
  public abstract class HelloServiceCoroutineImplBase(
    ...
    /**
     * Returns the response to an RPC for com.example.grpcservice.HelloService.SayHello.
     *
    ...
    public open suspend fun sayHello(request: HelloRequest): HelloReply = throw
        StatusException(UNIMPLEMENTED.withDescription("Method com.example.grpcservice.HelloService.SayHello is unimplemented"))
